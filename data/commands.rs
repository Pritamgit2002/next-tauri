// Copy of src-tauri/src/commands.rs — the Tauri (Rust) commands that read
// from and write to the local SQLite database. Kept here per the submission
// checklist; src-tauri/src/commands.rs is the version actually compiled.
